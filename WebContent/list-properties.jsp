...
<body>
	...
	<input type="button" value="Add Property" onclick="window.location.href='add-student-form.jsp'; return false;" class="add-student-button">	
<form name="searchForm" action="propertyControllerServlet" method="GET">
