...
public class GetPropertyDbUtil {
	...
	public List<GetProperty> getProperties() throws Exception {
		...
		try {
			...
			while (myRs.next()) {
				...
				GetProperty tempProperty = new GetProperty(property_id, type_name, address, suitable_for, availability, owner, rented_by, rent);
